...
export const config = {
  light: vars({
    /* Primary - Blue #135bec */
    '--color-primary-0': '237 243 254',
    '--color-primary-50': '219 231 253',
    '--color-primary-100': '183 207 250',
    '--color-primary-200': '146 183 247',
    '--color-primary-300': '110 159 244',
    '--color-primary-400': '73 135 241',
    '--color-primary-500': '19 91 236',
    '--color-primary-600': '17 82 212',
    '--color-primary-700': '14 68 177',
    '--color-primary-800': '11 55 141',
    '--color-primary-900': '8 41 106',
    '--color-primary-950': '5 27 71',
  ...
  dark: vars({
    /* Primary - Blue #135bec (same in dark mode for brand consistency) */
    '--color-primary-0': '5 27 71',
    '--color-primary-50': '8 41 106',
    '--color-primary-100': '11 55 141',
    '--color-primary-200': '14 68 177',
    '--color-primary-300': '17 82 212',
    '--color-primary-400': '19 91 236',
    '--color-primary-500': '19 91 236',
    '--color-primary-600': '73 135 241',
    '--color-primary-700': '110 159 244',
    '--color-primary-800': '146 183 247',
    '--color-primary-900': '183 207 250',
    '--color-primary-950': '219 231 253',
