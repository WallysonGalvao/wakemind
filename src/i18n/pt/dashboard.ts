export const dashboardPT = {
  ...
  'dashboard.wakeConsistency.noData': 'Complete mais alarmes para ver o gráfico',
  'dashboard.wakeConsistency.needMoreDays': 'Complete alarmes em mais dias para ver o gráfico',
