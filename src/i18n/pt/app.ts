export const appPT = {
  ...
  'newAlarm.challenges.memory.description': 'Memorize um padrão de blocos iluminados.',
  'newAlarm.challenges.logic.title': 'Desafio de Lógica',
  ...
  'permissions.batteryOptimization': 'Desativar Otimização de Bateria',
  'permissions.batteryOptimizationDescription':
    'Para alarmes confiáveis, desative a otimização de bateria para o WakeMind. Isso garante que os alarmes toquem mesmo quando o celular estiver em repouso.',
  'permissions.fullScreenRequired': 'Ativar Notificações em Tela Cheia (Android 14+)',
  'permissions.fullScreenDescription':
    'Para abrir o app automaticamente quando o alarme tocar, ative "Permitir notificações em tela cheia" nas configurações de notificação do WakeMind. Isso é crítico para acordá-lo efetivamente.',
  ...
  'performance.quotes': [
    'Disciplina é igual à liberdade.',
    'Desperte sua mente. Execute seu dia.',
    'Consistência constrói excelência.',
    'Cada desafio aguça sua mente.',
    'Sua rotina matinal define seu dia.',
    'Pequenas vitórias criam hábitos duradouros.',
    'Clareza mental começa com um despertar intencional.',
    'Progresso é construído um dia de cada vez.',
    'A mente fica mais forte a cada desafio.',
    'Compromisso hoje, sucesso amanhã.',
    'Domine suas manhãs, domine sua vida.',
    'Força cognitiva é uma prática diária.',
    'Levante com intenção, execute com precisão.',
    'Seu potencial desperta com você.',
    'Excelência é um hábito, não um acidente.',
    'O melhor investimento é na sua manhã.',
    'Afie sua mente, afie seu futuro.',
    'Vença a soneca, abrace o desafio.',
    'Cada manhã é uma nova oportunidade.',
    'Condicionamento mental exige treino diário.',
    'Vença a manhã, vença o dia.',
    'Seu cérebro é sua ferramenta mais poderosa.',
    'Consistência sobre intensidade.',
    'Comece forte, termine mais forte.',
    'Construa momentum desde o primeiro momento.',
    'Desafio aceito, crescimento garantido.',
    'O alarme é seu chamado para a grandeza.',
    'Manhãs intencionais criam dias excepcionais.',
    'Sua mente merece um começo poderoso.',
    'Transforme seu despertar, transforme sua vida.',
  ],
  'performance.dailyAvg': 'Média Diária',
  'performance.best': 'Melhor',
  'performance.lastWeek': 'Semana Passada',
