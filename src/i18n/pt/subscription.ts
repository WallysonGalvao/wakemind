export default {
  ...
  'paywall.features.allDifficulties.description':
    'Acesse modo Difícil e dificuldade Adaptativa com IA',
  'paywall.features.advancedStats.title': 'Estatísticas Avançadas',
  'paywall.features.advancedStats.description': 'Análises detalhadas com histórico de 365 dias',
  'paywall.features.streakFreeze.title': 'Congelar Sequência',
  'paywall.features.streakFreeze.description': 'Proteja sua sequência com 3 tokens por mês',
