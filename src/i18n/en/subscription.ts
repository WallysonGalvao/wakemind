export default {
  ...
  'paywall.plans.introOffer.free': 'free',
  'paywall.plans.introOffer.day_one': '{{count}} day',
  'paywall.plans.introOffer.day_other': '{{count}} days',
  'paywall.plans.introOffer.week_one': '{{count}} week',
  'paywall.plans.introOffer.week_other': '{{count}} weeks',
  'paywall.plans.introOffer.month_one': '{{count}} month',
  'paywall.plans.introOffer.month_other': '{{count}} months',
  'paywall.plans.introOffer.year_one': '{{count}} year',
  'paywall.plans.introOffer.year_other': '{{count}} years',

  'paywall.cta.subscribe': 'Start Free Trial',
  'paywall.cta.trial': 'Start 7-Day Free Trial',
  'paywall.cta.startTrial': 'START {{period}} FREE TRIAL',
