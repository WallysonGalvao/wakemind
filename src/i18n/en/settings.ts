export const settingsEN = {
  ...
  'vibration.gentle': 'Gentle',
  'vibration.gentleDescription': 'Light vibration every 3 seconds. For light sleepers.',
  'vibration.moderate': 'Moderate',
  'vibration.moderateDescription': 'Medium vibration every 2 seconds. Balanced wake-up.',
  'vibration.intense': 'Intense',
  'vibration.intenseDescription': 'Strong vibration every second. For heavy sleepers.',
  'vibration.progressive': 'Progressive',
  'vibration.progressiveDescription': 'Starts gentle and intensifies over time until you wake up.',

  // Sound & Haptics
  'settings.alarmTone': 'Alarm Tone',
  'settings.alarmVolume': 'Alarm Volume',
  'settings.vibrateOnSuccess': 'Vibrate on Success',
  'settings.vibrationPattern': 'Vibration Pattern',

  // Behavior
  'settings.snoozeProtection': 'Snooze Protection',
  'settings.preventAutoLock': 'Prevent Auto-Lock',
  'settings.preventAutoLockDescription': 'Keeps screen active during cognitive challenges.',
  ...
  'alarmTone.tone.rooster-short.name': 'Rooster Short',
  'alarmTone.tone.rooster-short.category': 'Circadian Trigger',
