export const appEN = {
  ...
  'performance.quotes': [
    ...
    'Every challenge sharpens your mind.',
    'Your morning routine defines your day.',
    'Small wins create lasting habits.',
    'Mental clarity starts with a purposeful wake-up.',
    'Progress is built one day at a time.',
    'The mind grows stronger with every challenge.',
    'Commitment today, success tomorrow.',
    'Master your mornings, master your life.',
    'Cognitive strength is a daily practice.',
    'Rise with intention, execute with precision.',
    'Your potential awakens with you.',
    'Excellence is a habit, not an accident.',
    'The best investment is in your morning.',
    'Sharpen your mind, sharpen your future.',
    'Defeat the snooze, embrace the challenge.',
    'Every morning is a fresh opportunity.',
    'Mental fitness requires daily training.',
    'Win the morning, win the day.',
    'Your brain is your most powerful tool.',
    'Consistency over intensity.',
    'Start strong, finish stronger.',
    'Build momentum from the first moment.',
    'Challenge accepted, growth delivered.',
    'The alarm is your call to greatness.',
    'Intentional mornings create exceptional days.',
    'Your mind deserves a powerful start.',
    'Transform your wake-up, transform your life.',
  ],
  'performance.dailyAvg': 'Daily Avg',
