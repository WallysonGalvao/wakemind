export default {
  ...
  'paywall.features.allDifficulties.description':
    'Accede al modo Difícil y dificultad Adaptativa con IA',
  'paywall.features.advancedStats.title': 'Estadísticas Avanzadas',
  'paywall.features.advancedStats.description': 'Análisis detallado con historial de 365 días',
  'paywall.features.streakFreeze.title': 'Congelar Racha',
  'paywall.features.streakFreeze.description': 'Protege tu racha con 3 tokens por mes',
